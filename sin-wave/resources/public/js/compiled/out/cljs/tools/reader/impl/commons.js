...
var G__24183 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24183;
continue;
} else {
return ch;
...
var vec__24184 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__24184,(0),null);
return (match === s);
});
...
var G__24191 = (i__4737__auto___24190 + (1));
i__4737__auto___24190 = G__24191;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq24187){
...
return (function() { 
var G__24192__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__24192 = function (rdr,var_args){
var _ = null;
...
while (G__24193__i < G__24193__a.length) {G__24193__a[G__24193__i] = arguments[G__24193__i + 1]; ++G__24193__i;}
  _ = new cljs.core.IndexedSeq(G__24193__a,0,null);
} 
return G__24192__delegate.call(this,rdr,_);};
G__24192.cljs$lang$maxFixedArity = 1;
G__24192.cljs$lang$applyTo = (function (arglist__24194){
var rdr = cljs.core.first(arglist__24194);
var _ = cljs.core.rest(arglist__24194);
return G__24192__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1614970913437
